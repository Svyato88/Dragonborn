...
public class Spruce_forest_cold {
    public static final ResourceKey<Biome> SPRUCE_FOREST_COLD = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(Dragonborn.MOD_ID,"spruce_forest_cold"));

    public static void boostrap(BootstapContext<Biome> context){
        context.register(SPRUCE_FOREST_COLD, spruce_forest_cold(context));
    }
    ...
    public static Biome spruce_forest_cold(BootstapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, SpruceForestFeaturesPlaced.SPRUCE_STUMP_SF);
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, SpruceForestFeaturesPlaced.ASARUM_DRY);
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, SpruceForestFeaturesPlaced.FALLEN_SPRUCE_BRANCH);
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, SpruceForestFeaturesPlaced.FERN_PATCH_BIG);
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, SpruceForestFeaturesPlaced.FERN_BUSH_BIG);
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, SpruceForestFeaturesPlaced.FERN_BUSH_DRY_BIG);
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, SpruceForestFeaturesPlaced.TREE_BUSH_PATCH_SSF);
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, SpruceForestFeaturesPlaced.PRICKLY_PLANT);
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, SpruceForestFeaturesPlaced.SNOWBERRIES_BUSH);
